...
/*    	return ResponseEntity.created(new URI("/api/authenticate")
        ...
        private String getSuperAdminLogin() throws UnsupportedEncodingException{
            log.debug("REST request for super admin token");
	       
	       UserUIDTO userUIDTO = customerService.getUserWithAuthoritySuperAdmin();
	       
	       return userUIDTO.getLogin();
   }
