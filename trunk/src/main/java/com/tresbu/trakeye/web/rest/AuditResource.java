...
import com.tresbu.trakeye.service.AuditEventService;
...
public class AuditResource {
    ...
    @ApiOperation(value = "Get list of audits", notes = "User can list of audit events. User with role Super Admin is allowed.", response = AuditEvent.class)
    ...
    @Secured({AuthoritiesConstants.SUPER_ADMIN})
    @ApiOperation(value = "Get list of audits by date", notes = "User can list of audit events created within given from and to dates. User with role Super Admin is allowed.", response = AuditEvent.class)
    ...
    @Secured({AuthoritiesConstants.SUPER_ADMIN})
    @ApiOperation(value = "Get audit event by id", notes = "User can find audit even by id. User with role Super Admin is allowed.", response = AuditEvent.class)
