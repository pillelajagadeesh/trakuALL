(function() {
    ...
    AssetDialogController.$inject = ['$timeout', '$scope', '$stateParams', 'entity', 'Asset', 'User', 'AssetType', '$state'];

    function AssetDialogController ($timeout, $scope, $stateParams, entity, Asset, User, AssetType, $state) {
        var vm = this;
