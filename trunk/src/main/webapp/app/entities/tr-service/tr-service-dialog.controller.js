(function() {
    ...
    TrServiceDialogController.$inject = ['$timeout', '$scope','$http', '$stateParams', 'entity', '$state', 'TrService', 'User', 'TrCase', 'ServiceType','UserSearch','$sce', '$q','$rootScope'];

    function TrServiceDialogController ($timeout, $scope,$http, $stateParams, entity, $state, TrService, User, TrCase, ServiceType,UserSearch,$sce, $q,$rootScope) {
        var vm = this;
