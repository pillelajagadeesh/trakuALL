(function() {
    ...
    TrServiceController.$inject = ['$scope', '$state','$compile', 'TrService', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants','TrCaseUser' , 'TrServiceSearch'];

    function TrServiceController ($scope, $state,$compile, TrService, ParseLinks, AlertService, pagingParams, paginationConstants,TrCaseUser, TrServiceSearch) {
        var vm = this;
        ...
        function filterSearch(){
			...
			TrServiceSearch.query({userId:vm.search},{
                page: pagingParams.page - 1,
                size: vm.itemsPerPage,
                sort: sort()
            }, onSuccess, onError);
