...
public class TrServiceCreateDTO implements Serializable {
	...
	public String toString() {
		return "TrServiceCreateDTO [description=" + description + ", serviceDate=" + serviceDate + ", status=" + status
				+ ", notes=" + notes + ", reportedBy=" + reportedBy + ", user=" + user + ", updatedBy=" + updatedBy
				+ ", trCase=" + trCase + ", serviceImages=" + serviceImages + ", serviceTypeAttributeValues="
				+ serviceTypeAttributeValues + ", serviceType=" + serviceType + "]";
	}
