 ...
 */
public class TrNotificationListDTO implements Serializable {
	...
	public boolean equals(Object o) {
		...
		TrNotificationListDTO trNotificationListDTO = (TrNotificationListDTO) o;

		if (!Objects.equals(id, trNotificationListDTO.id))
			return false;
	...
	public String toString() {
		return "TrNotificationListDTO [id=" + id + ", createdDate=" + createdDate + ", description=" + description
